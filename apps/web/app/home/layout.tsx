  ...
  return (
    <SidebarProvider defaultOpen={sidebarMinimized}>
      <Page style={'sidebar'}>
        ...
        {/* Wrap children + ComplianceBanner in a single element because
            getSlotsFromPage() only keeps the LAST non-slot child. */}
        <div className="flex flex-1 flex-col">
          {children}

          {/* PRD §22: Persistent compliance footer in dashboard */}
          <ComplianceBanner />
        </div>
      </Page>
    </SidebarProvider>
